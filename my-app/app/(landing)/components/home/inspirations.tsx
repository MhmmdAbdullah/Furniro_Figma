...
const Inspirations = () => {
  ...
  return (
    <section className="bg-primary-lighthome2 max-h-[670]">
      <div className="py-11 flex gap-10.5 container mx-auto items-center">
        <div className="ml-25 flex flex-col gap-6">
          <div className="flex flex-col gap-2 max-w-105.5 ">
        ...
        <div className="flex gap-6">
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="relative">
              <button
                onClick={handleNext}
                className="absolute -right-5 bottom-84  w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors duration-300"
